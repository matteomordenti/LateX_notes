...
il suo avanzamento del processo:
...
multiprogramming e multiprogramming condividono gli stessi errori derivanti dal fatto che non e possibile predirre gli istanti temporali in cui avvengono le operaziooni e i processi accedono a risorse condivise
...
esistono processi concorrenti “ignari l’uno dell’altro”, sono indipendenti m concorrono per le stesse risorse, il sistema deve arbitrarle  e sincronizzarle. questi non sono creati per lavorare insiem 
...
non abbaimo eliminato il busy waiting ma lo abbiamo limitato molto
\end{document}